...
public class DynmapsAR extends PApplet{
PApplet parent;
	
	public static void main(String _args[]){
		
		PApplet.main(new String[]{"--present", "lca.DynmapsAR"});
		/*main mn = new main();
...
int rowc()
{
Table table1 = loadTable("C:\\Users\\Nitesh\\Desktop\\Priyal Files\\Input.csv", "header");
...
public void setup() {
 ...
 Table table = loadTable("C:\\Users\\Nitesh\\Desktop\\Priyal Files\\Input.csv", "header");
...
{ 
  ...
  text ( "Impact = " , 40, 1000);
  fill(194,153,106);
  arc(60, 1090, 15, 15, 0, (float) (0.65*6.2831) , PIE);
  fill(0);
  
  text(" Confidence = "+ 0.6240 * 100 + "%" , 25, 1070);
  fill(194,153,106);
  arc(80, 1090, 15, 15, 0, (float) (0.62*6.2831) , PIE);
  fill(0);
  //text("  "+ 0.6246 * 100 + "%" , 70, 1070);
  text("  "+ 0.6450 * 100 + "%" , 70, 1070);
 /* fill(116,76,39);
