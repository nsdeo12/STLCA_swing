...
public class Dynmaps_space extends PApplet{
PApplet parent;
	
	public static void main(String _args[]){
		
		PApplet.main(new String[]{"--present", "lca.Dynmaps_space"});
		/*main mn = new main();
...
int rowc()
{
Table table1 = loadTable("C:\\Users\\Nitesh\\Downloads\\original\\Input.csv", "header");
...
public void setup() {
 ...
 Table table = loadTable("C:\\Users\\Nitesh\\Downloads\\original\\Input.csv", "header");
...
ellipse(1070,320, 30,30);}
 ...
 // text("OVERALL", Vis+20, 340);
  text("Impact = " +iovesum/1000,  1150,300);
