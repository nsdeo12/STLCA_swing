...
public class smcalc12 extends PApplet {
	
	PApplet parent;

	public smcalc12(PApplet _parent){
		parent = _parent;
	}
	...
	public static void main(String _args[]){
		PApplet.main(new String[]{"--present", "lca.smcalc12"});
	}
...
//	int rows = 55; // Row no 2 to Row no Last... n-1 rows from excel
	...
	public void setup() {
	  ...
	  Table table2 = loadTable("C:\\Users\\Nitesh\\Desktop\\Priyal Files\\Code\\proimpact1\\Partprocess.csv", "header");
	  z = table2.getRowCount();
    	 x= table2.getColumnCount();
	    ...
	    for (int j = 1; j < z-1; j++) {
	      ...
	      TableRow row2 = table2.getRow(j);
	      if (i==0) {
	    	 
	        //String[] Partname = table1.getStringColumn("Part_assem_name");
	        //pa[0][j] = row2.getString("Part_assem_name");
	        tr[0][j] = row2.getFloat("Part_assem_name");
	      } else if (i==1)
	      { 
	        tr[1][j] = row2.getFloat("UID");
	      } else if (i==2) {
	        tr[2][j] = row2.getFloat("StatusPP");
	      } else if (i==3) {
	        tr[3][j] = row2.getFloat("1");
	      } else if (i==4) {
	        tr[4][j] = row2.getFloat("2");
	      } else if (i==5) {
	        tr[5][j] = row2.getFloat("3");
	      } else if (i==6) {
	        tr[6][j] = row2.getFloat("4");
	      } else if (i==7) {
	        tr[7][j] = row2.getFloat("5");
	      } else if (i==8) {
	        tr[8][j] = row2.getFloat("6");
	      }
	    }
	  }
	...
	{  
	  for (int k6=0; k6<rows1; k6++) {
	    for (int k7=0; k7<rows; k7++) {
	      { 
	        if (pp[1][UID] == loctime[26][k7]) //[1][0 to k6]( 26 - assigned to component id )
	        {
	          loctime[27][k7]=loctime[23][k7]; //( 27 - Variable class ) ( 23- class - Sub ass , Part or assembly)
	          for (int k8=3; k8<cols1; k8++) {
	            for (int k9=0; k9<rows; k9++) {
	              if (pp[k8][UID] == loctime[26][k9])// ( Id = assigned component id )
	              {
	                loctime[27][k9]=loctime[23][k9];// (variable class = sub ass paryt or assembly)
	              }
	            }
	          }
	        }
	  ...
	  { 
	      ...
	      imatsump=ipro1p; //Material Sum Impact
	...
	{    
	 ...
	 rect(Vis, Vis-(imatsumc/100)+Vis1, Vis+20, Vis+Vis1 );*/
	  arc(Vis+10, Vis+20+Vis1, 20, 20, 0, (float) (ConfidencePro1c*6.2831), PIE);
		if ((imatsumc/1000) >=0.3){
			   fill(239,62,52);
			 ellipse(100,20, 10,10);}
			 else if  (((imatsumc/1000)>=0.1) && (imatsumc/1000)<0.3){
			   fill(241,89,40);
			 ellipse(100,20, 10,10);}
			  else if  (((imatsumc/1000)>=0.06) && (imatsumc/1000)<0.1){
			   fill(241,89,40);
			 ellipse(100,20, 10,10);}
			 else if (((imatsumc/1000)>=0.02) && (imatsumc/1000)<0.03){
			   fill(251,175,63);
			 ellipse(100,20, 10,10);}
			    else if (((imatsumc/1000)>=0.01) && (imatsumc/1000)<0.02){
			   fill(247,236,46);
			 ellipse(100,20, 10,10);}
			    else if (((imatsumc/1000)>=0.0004) && (imatsumc/1000)<0.01){
			   fill(214,223,34);
			 ellipse(100,20, 10,10);}
			    else if (((imatsumc/1000)>=0.0003) && (imatsumc/1000)<0.0004){
			   fill(140,198,62);
			 ellipse(100,20, 10,10);}
			    else if (((imatsumc/1000)>=0.0002) && (imatsumc/1000)<0.0003){
			   fill(36,181,114);
			 ellipse(100,20, 10,10);}
			    else if ((imatsumc/1000)<=0.0002){ 
			   fill(0,173,239);
			 ellipse(100,20, 10,10);}
