...
public class dynmaps15 extends PApplet {
	PApplet parent;
	...
	int rowc()
	{Table table1 = loadTable("C:\\Users\\Nitesh\\Desktop\\Priyal Files\\Code\\dynmaps15\\Input.csv", "header");
	...
	public static void main(String _args[]){
		PApplet.main(new String[]{"lca.dynmaps15"});
	}
	...
	public void setup() {
	 ...
	 // Table table = loadTable("M:\\templates\\Input.csv", "header");
	  ...
	  Table table = loadTable("C:\\Users\\Nitesh\\Desktop\\Priyal Files\\Code\\dynmaps15\\Input.csv", "header");
	...
	ellipse(1070,320, 30,30);}
	 ...
	 // text("OVERALL", Vis+20, 340);
	  text("Impact = " +iovesum/1000000,  Vis-10 ,300);
