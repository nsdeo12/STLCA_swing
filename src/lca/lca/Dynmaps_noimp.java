...
public class Dynmaps_noimp extends PApplet {
	PApplet parent;
	public static void main(String _args[]){
		PApplet.main(new String[]{"lca.Dynmaps_noimp"});
	}
	int xmap; 
	int numcol=1;
	...
	public void setup() {
	  ...
	  Table table = loadTable("C:\\Users\\Nitesh\\Desktop\\Priyal Files\\Code\\dynmaps12\\Input.csv", "header");
	...
	{ 
	  ...
	  fill(0);
	  text(ipart6c, check, max(yloctime[0])+40);
	  text(numcol, check, 7);
	  ipart6c=0;
	  numcol=0;
	}
